...
public class TestLoginPage extends BaseClass {
	...
	public void TestClickCartButton() {
		...
		WebElement WebELProd1 = driver
				.findElement(By.xpath("//a[@id='item_4_title_link' and @data-test='item-4-title-link']"));
		WebElement WebELProd2 = driver
				.findElement(By.xpath("//a[@id='item_0_title_link' and @data-test='item-0-title-link']"));
		WebElement WebELProd3 = driver
				.findElement(By.xpath("//a[@id='item_1_title_link' and @data-test='item-1-title-link']"));
	...
	public void GenerateRandomUser() {
		...
		WebElement WP1 = driver.findElement(By.xpath(
				"(//div[@class='inventory_item_price' and @data-test='inventory-item-price' and contains(text(), '$')])[1]"));
		String Price1 = WP1.getText().replace("$", "").trim();
		double dValue1 = Double.parseDouble(Price1);

		WebElement WP2 = driver.findElement(By.xpath(
				"(//div[@class='inventory_item_price' and @data-test='inventory-item-price' and contains(text(), '$')])[2]"));
		String Price2 = WP2.getText().replace("$", "").trim();
		double dValue2 = Double.parseDouble(Price2);

		WebElement WP3 = driver.findElement(By.xpath(
				"(//div[@class='inventory_item_price' and @data-test='inventory-item-price' and contains(text(), '$')])[3]"));
	...
	public void ClickOnFinishButton() throws InterruptedException, IOException {
		...
		WebElement Logout = driver.findElement(By.xpath(
				"//a[@id='logout_sidebar_link' and contains(@class, 'bm-item') and contains(@class, 'menu-item') and @data-test='logout-sidebar-link' and text()='Logout']"));
		Logout.click();
	}
